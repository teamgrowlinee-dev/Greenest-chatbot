...
function pickCartRecipeWithAI_(cartProductNames, candidates) {
  ...
  var prompt = [
    ...
    lines.join('\n'),
    '',
    'Vali 1-3 kõige sobivamad retseptid arvestades ostukorvi tooteid.',
    '',
...
function doGet(e) {
  ...
  var ALT_MAP = {
    ...
    '18071': ['18065', '18066', '18069']
      ...
      function colIdx_(name) { return hdr.indexOf(name); }
      ...
      for (var r = 1; r < allData.length; r++) {
        ...
        for (var n = 1; n <= 12; n++) {
          var pidIdx = colIdx_('ing' + n + '_product_id');
          ...
          for (var a = 1; a <= 3; a++) {
            var altColIdx = colIdx_('ing' + n + '_alt' + a + '_product_id');
      ...
      return jsonResponse_({ ok: true, action: 'writeAltProducts', updatedCells: updatedCells, updatedRows: updatedRows });
    }
